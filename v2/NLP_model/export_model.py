...
# === Save the Logistic Regression Model Only ===
model_save_path = r"C:\Users\ahmty\Desktop\HFU\6 Sechstesemester\NLP\project\prototype\v2\NLP_model\exported_model\exported_model_logreg.pkl"

with open(model_save_path, 'wb') as f:
    pickle.dump(logreg, f)

print(f"\nLogistic Regression model successfully saved to:\n{model_save_path}")
